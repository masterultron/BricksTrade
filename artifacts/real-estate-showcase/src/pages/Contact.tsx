...
export default function Contact() {
  ...
  return (
    <div className="bg-[hsl(var(--background))]">
          ...
          <div className="mt-20 grid gap-16 border-t border-[hsl(var(--foreground)/.2)] pt-8 md:grid-cols-[.75fr_1.25fr] md:gap-28">
            <div className="space-y-10">
              ...
              <a href="https://maps.google.com/?q=1st+Avenue+Suite+B3+Irama+Plaza+Gwarinpa+Abuja+Nigeria" target="_blank" rel="noreferrer" className="group block overflow-hidden border border-[hsl(var(--foreground)/.18)] bg-[hsl(var(--muted))]" data-testid="link-office-map">
                ...
                <div className="flex items-center justify-between p-4 text-sm"><span>1st Avenue, Suite B3<br />Irama Plaza, Gwarinpa, Abuja</span><ArrowUpRight size={16} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></div>
              </a>
            </div>
            <div>
      ...
      <section className="bg-[hsl(var(--secondary))] px-5 py-16 text-[hsl(var(--background))] md:px-10 md:py-20"><div className="mx-auto flex max-w-[1400px] flex-col justify-between gap-5 md:flex-row md:items-center"><p className="display text-4xl md:text-5xl">Good places start with<br /><em className="text-[hsl(var(--accent))]">good questions.</em></p><div className="flex gap-8 text-sm opacity-80"><span className="flex items-center gap-2"><MapPin size={15} /> Irama Plaza, Gwarinpa</span><span className="flex items-center gap-2"><Phone size={15} /> By appointment</span></div></div></section>
    </div>
  );
}